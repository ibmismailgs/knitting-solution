...
@section('title', 'Fabric-Receive-Update')
@section('content')
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Receive Fabric</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              {!! Form::model($data, ['method' => 'PATCH','route' => ['fabric_receive.update', $data->id]]) !!}
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="chalan" class="form-control" id="chalan" value="{{ $data->chalan_no }}" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="gate_pass" class="col-sm-2 col-form-label">Gate pass</label>
                    <div class="col-sm-10">
                        <input type="text" name="gate_pass" class="form-control" id="gate_pass" value="{{ $data->gate_pass_no }}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="stl_no" class="form-control" id="stl_no" value="{{ $data->stl_no }}" readonly>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <?php $length = count($fab_details); ?>
                    @foreach ($fab_details as $key => $fab)
                            ...
                            <div class="col-md-11">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="lot[]" id="lot" placeholder="Yarn lot" type="text" class="form-control" value="{{ old('lot',optional($fab)->lot) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            <label for="count" class="">Yarn count</label>
                                            <input type="text" name="count[]" id="count" placeholder="Yarn count" class="form-control" value="{{ old('count',optional($fab)->count) }}" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        ...
                                        <input name="roll[]" id="roll" placeholder="Enter roll" type="text" class="form-control" value="{{ old('roll',optional($fab)->roll) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="quantity[]" id="quantity" placeholder="Quantity(Kg)" type="number" step="0.01" class="form-control amount" value="{{ old('quantity',optional($fab)->quantity) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                      ...
                      @elseif($key > 0)
                        @if ($key == 1) <div id="more_field"> @endif
                            <div class="row">
                                <div class="col-md-1">
                                    <a href="#" class="remove_field">
                                        <button class="btn btn-warning mt-4"><i class="fa fa-minus" title="Remove Item"></i></button>
                                    </a>
                                </div>
                                <div class="col-md-11">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="lot" class="">Yarn lot</label>
                                                <input name="lot[]" id="lot" placeholder="Yarn lot" type="text" class="form-control" value="{{ old('lot',optional($fab)->lot) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="count" class="">Yarn count</label>
                                                <input type="text" name="count[]" id="count" placeholder="Yarn count" class="form-control" value="{{ old('count',optional($fab)->count) }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="roll" class="">Roll</label>
                                                <input name="roll[]" id="roll" placeholder="Enter roll" type="text" class="form-control" value="{{ old('roll',optional($fab)->roll) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="quantity" class="">Quantity(Kg)</label>
                                                <input name="quantity[]" id="quantity" placeholder="Quantity(Kg)" type="number" step="0.01" class="form-control amount" value="{{ old('quantity',optional($fab)->quantity) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        @if ($key == $length - 1 ) </div> @endif
                       @endif
                    ...
                    <div class="col-md-11">
                          <div class="form-row">
                            <div class="col-md-6">
                              <div class="position-relative form-group">
                                <label for="lot" class="">Yarn lot</label>
                                <input name="lot[]" id="lot" placeholder="Yarn lot" type="text" class="form-control" value="{{ old('lot') }}">
                              </div>
                          </div>
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                  <label for="count" class="">Yarn count</label>
                                  <input type="text" name="count[]" id="count" placeholder="Yarn count" class="form-control" value="{{ old('count') }}">
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="form-row">
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                  <label for="roll" class="">Roll</label>
                                  <input name="roll[]" id="roll" placeholder="Enter roll" type="text" class="form-control" value="{{ old('roll') }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="position-relative form-group">
                                  <label for="quantity" class="">Quantity(Kg)</label>
                                  <input name="quantity[]" id="quantity" placeholder="Quantity(Kg)" type="number" class="form-control amount" value="{{ old('quantity') }}">
                                </div>
                            </div>
                          </div>
                        </div>
