...
<html>
  <head>
    ...
    <title>DeliveryBill-{{ $dalivery->bill }}</title>
                                        ...
                                        <div class="card-body" style="padding:0px">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 app-head">
                                                    <p>Party's Name : {{$dalivery->party->name}}</p>
                                                    <p>Address : {{$dalivery->party->address}}</p>
                                                    <p>Driver : {{$dalivery->driver}} </p>
                                                    <p>Truck Number: {{$dalivery->truck_number}}</p>
                                                </div>
                                                <div class="col-md-4 app-head">
                                                    <h2 class="invoice_title">Delivery Bill</h2>
                                                </div>
                                                <div class="col-md-4 date">
                                                    <p>Date: {{$dalivery->date}}</p>
                                                    <p>No: <b>{{$dalivery->chalan}}</b></p>
                                                    @php
                                                    ...
                                                    <table class="custom_table" width="100%">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th width="10%" style="text-align:center;">Dia/Gauge</th>
                                                        ...
                                                        <tbody>
                                                            @php
                                                                $total_qty = 0; $total_roll = 0; $total_amount = 0;
                                                            @endphp
                                                            @foreach($delivery_details as $key=>$detail)
                                                                <tr>
                                                                    <td>{{$key+1}}</td>
                                                                    <td style="text-align:center;">
                                                                       Buyer Name- {{$detail->buyer_name}}, Fabric Type-{{$detail->fabric_type}}, Color-{{$detail->colour}}, Brand-{{$detail->brand}}, Count-{{$detail->count}}, Lot-{{$detail->lot}},
                                                                       MC/DIA-{{$detail->mc_dia}}, F/DIA-{{$detail->f_dia}}, F/GSM-{{$detail->f_gsm}}, SL-{{$detail->sl}}
                                                                    </td>
                                                                    <td style="text-align:center;">{{$detail->dia_gauza}}</td>
                                                                    <td style="text-align:center;">{{$detail->roll}}</td>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <th width="10%"></th>
                                                                <th width="10%" style="text-align:center;">{{ $total_roll }}</th>
                                                                <th width="5%" style="text-align:center;">{{ $total_qty }}</th>
                                                                <th width="5%"></th>
