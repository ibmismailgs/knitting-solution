...
<html>
  <head>
    ...
    <title>DeliveryChallan-{{ $delivery->chalan }}</title>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($delivery_details as $key=>$delivery)
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center;">{{ $delivery->rate }}</td>
                                                                    <td style="text-align:center;">{{ $delivery->amount }}</td>
                                                                    <td></td>
                                                                    @php
