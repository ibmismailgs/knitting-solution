...
<html>
  <head>
    ...
    <title>GatePass-{{ $delivery->chalan }}</title>
                                        ...
                                        <div class="card-body" style="padding:0px">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 app-head">
                                                    <p>No: <b>{{ $delivery->gate_pass }}</b></p>
                                                    <p>Party's Name : {{ $delivery->party->name }}</p>
                                                    <p>Address : {{ $delivery->party->address }}</p>
                                                    <p>Driver :  {{ $delivery->driver }}</p>
                                                    <p>Truck Number: {{ $delivery->truck_number }}</p>
                                                </div>
                                                <div class="col-md-4 app-head">
                                                    <h2 class="invoice_title">Gate Pass</h2>
                                                </div>
                                                <div class="col-md-4 date">
                                                    <p>Date: {{ $delivery->date }}</p>
                                                    <p>Challan No: <b>{{ $delivery->chalan }}</b></p>
                                                    @php
                                                    ...
                                                    <table class="custom_table" width="100%">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th width="15%" style="text-align:center;">Roll</th>
                                                        ...
                                                        <tbody>
                                                            @php
                                                                $total_qty = 0; $total_amount = 0; $total_toll = 0;
                                                            @endphp
                                                            @foreach ($delivery_details as $key=>$delivery)
                                                                <tr>
                                                                    <td>{{ $key+1 }}</td>
                                                                    <td>
                                                                        Buyer Name: {{ $delivery->buyer_name }}, Lot: {{ $delivery->lot }}, Count: {{ $delivery->count }}
                                                                    </td>
                                                                    <td style="text-align:center;">{{ $delivery->roll }}</td>
                                                                    <td style="text-align:center;">{{ $delivery->quantity }}</td>
                                                                    <td></td>
                                                                    @php
                                                                        $total_qty += $delivery->quantity;
                                                                        $total_amount += $delivery->amount;
                                                                        $total_toll += $delivery->roll;
                                                                    @endphp
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <th width="15%" style="text-align:center;">{{ $total_toll }}</th>
                                                                <th width="15%" style="text-align:center;">{{ $total_qty }}</th>
                                                                <th width="15%"></th>
                                                            </tr>
                                                       </tfoot>
                                                    </table>
