                  ...
                  <div class="form-row">
                    <div class="col-md-3">
                      <div class="position-relative form-group">
                          ...
                          <input type="date" name="date" class="form-control" id="date" placeholder="Enter date" value="{{ old('date',optional($data)->date) }}"  required>
                      </div>   
                    </div>
                    <div class="col-md-3">
                      <div class="position-relative form-group">
                    ...
                    <div class="col-md-3">
                      <div class="position-relative form-group">
                          ...
                          <input type="text" name="bill_no" class="form-control" id="bill_no" value="{{ old('date',optional($data)->bill_no) }}" readonly required>
                      </div>   
                    </div>
                    <div class="col-md-3">
                      <div class="position-relative form-group">
                  ...
                  <div class="form-row">
                    <div class="col-md-4">
                      <div class="position-relative form-group">
                          ...
                          <input type="text" name="money_rec_no" class="form-control" id="money_rec_no" value="{{ old('date',optional($data)->money_rec_no) }}" placeholder="Enter Money Receive no" required>
                      </div>   
                    </div>
                    <div class="col-md-4">
                      <div class="position-relative form-group">
                          <label for="name" class="">Payable Amount</label>
                          <input type="text" class="form-control" id="payable_amount" value="{{ old('date',optional($data)->payable_amount) }}" placeholder="Payable Amount" readonly>
                      </div>   
                    </div>
                    <div class="col-md-4">
                      <div class="position-relative form-group">
                          <label for="name" class="">Bill Amount</label>
                          <input type="text" name="amount" class="form-control" id="amount" value="{{ old('date',optional($data)->amount) }}" placeholder="Enter Amount" required>
                      </div>   
                    </div>
                  </div> 
                </div>
