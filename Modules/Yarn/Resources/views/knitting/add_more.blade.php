        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              {!! Form::model($knitting_program, ['method' => 'PATCH','route' => ['knitting-program.add-more-qty', $knitting_program->id]]) !!}
                @csrf
                <div class="card-body">
                  <div class="form-group row">
                    <label for="date" class="col-sm-2 col-form-label">Date<span class="text-danger">*</span></label>
                    <div class="col-sm-10">
                        <input type="date" name="date" class="form-control" id="date" value="{{$knitting_program->date}}" required>
                    </div>
                  </div>
                  <div class="form-group row">
                        ...
                        <select name="party_id" id="party_id" class="form-control" required>
                            ...
                            @foreach ($parties as $party)
                                <option value="{{$party->id}}"
                                  @if($knitting_program->party_id == $party->id )
                                    selected
                                  @endif
                                  >{{$party->name}}</option>
                            @endforeach
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="party_order_no" class="form-control" id="party_order_no" value="{{$knitting_program->party_order_no}}" required>
                    </div>
                  </div>
                  {{-- STL Order Number --}}
                  {{-- <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="party_number" value="{{$knitting_program->party_id}}" readonly>
                    </div>
                  </div>
                  <div class="form-group row">
                ...
                <!-- /.card-body -->
                <input type="hidden" name="knitting_id" value="{{$knitting_program->id}}">
                {{-- <input type="hidden" name="stl_order_no" value="{{$knitting_program->stl_order_no}}"> --}}
